...
//  AVCam Swift
//
//  Created by chang xiao on 12/8/16.
...
class ProgressHUD: UIVisualEffectView {
    ...
    init(text: String) {
        self.text = text
        self.vibrancyView = UIVisualEffectView(effect:UIBlurEffect(style: UIBlurEffectStyle.light)) //UIVibrancyEffect(forBlurEffect: blurEffect))
    ...
    required init(coder aDecoder: NSCoder) {
        self.text = ""
        self.vibrancyView = UIVisualEffectView(effect:UIBlurEffect(style: UIBlurEffectStyle.light))
